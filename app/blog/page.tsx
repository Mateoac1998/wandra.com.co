...
export const metadata: Metadata = { title: `Historias y guías | ${site.shortName}`, description: 'Guías de Wandra sobre kombucha, ghee y una alimentación consciente.', alternates: { canonical: '/blog' } };
