...
export const products: Product[] = [
  ...
  { slug: 'kombucha-cafe', name: 'Kombucha Café', sku: 'KC', category: 'Kombucha', description: 'Kombucha artesanal con perfil de café, fría y lista para disfrutar.', image: media.origin, variants: [{ label: '280 ml', price: 8000, sku: 'KC028' }, { label: '500 ml', price: 12000, sku: 'KC050' }] },
  { slug: 'kombucha-jengibre', name: 'Kombucha de Jengibre', sku: 'KJEN', category: 'Kombucha', description: 'Kombucha artesanal con un perfil fresco y especiado de jengibre.', image: media.pack280, variants: [{ label: '280 ml', price: 8000, sku: 'KJEN028' }, { label: '500 ml', price: 12000, sku: 'KJEN050' }] },
  { slug: 'kombucha-flor-de-jamaica', name: 'Kombucha Flor de Jamaica', sku: 'KKFJ', category: 'Kombucha', description: 'Kombucha artesanal de flor de jamaica, de sabor frutal y ácido.', image: media.pack500, variants: [{ label: '280 ml', price: 8000, sku: 'KKFJ028' }, { label: '500 ml', price: 12000, sku: 'KKFJ050' }] },
  ...
  { slug: 'six-pack-kombucha-500-ml', name: 'Six pack de Kombucha 500 ml', sku: 'KSX500', category: 'Kombucha', description: 'Seis kombuchas de 500 ml para compartir o mantener tu nevera lista.', image: media.pack500, variants: [{ label: '6 botellas de 500 ml', price: 58000, sku: 'KSX500' }] },
];
