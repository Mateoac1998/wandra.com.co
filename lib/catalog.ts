...
export const products: Product[] = [
  ...
  { slug: 'mateo-cafe', name: 'Mateo Café', sku: 'MC', category: 'Mateo', description: 'Mateo artesanal con perfil de café, frío y listo para disfrutar.', image: '/assets/cloudinary-upload/wandra-origin-editorial.webp', variants: [{ label: '280 ml', price: 8000, sku: 'MC028' }, { label: '500 ml', price: 12000, sku: 'MC050' }] },
  { slug: 'mateo-jengibre', name: 'Mateo de Jengibre', sku: 'MJEN', category: 'Mateo', description: 'Mateo artesanal con un perfil fresco y especiado de jengibre.', image: '/assets/cloudinary-upload/wandra-pack-280-editorial.webp', variants: [{ label: '280 ml', price: 8000, sku: 'MJEN028' }, { label: '500 ml', price: 12000, sku: 'MJEN050' }] },
  { slug: 'mateo-flor-de-jamaica', name: 'Mateo Flor de Jamaica', sku: 'MKFJ', category: 'Mateo', description: 'Mateo artesanal de flor de jamaica, de sabor frutal y ácido.', image: '/assets/cloudinary-upload/wandra-pack-500-editorial.webp', variants: [{ label: '280 ml', price: 8000, sku: 'MKFJ028' }, { label: '500 ml', price: 12000, sku: 'MKFJ050' }] },
  ...
  { slug: 'six-pack-mateo-280-ml', name: 'Six pack de Mateo 280 ml', sku: 'MSX280', category: 'Mateo', description: 'Seis Mateo de 280 ml para armar tu ritual de sabores.', image: '/assets/cloudinary-upload/wandra-pack-280-editorial.webp', variants: [{ label: '6 botellas de 280 ml', price: 42000, sku: 'MSX280' }] },
  { slug: 'six-pack-mateo-500-ml', name: 'Six pack de Mateo 500 ml', sku: 'MSX500', category: 'Mateo', description: 'Seis Mateo de 500 ml para compartir o mantener tu nevera lista.', image: '/assets/cloudinary-upload/wandra-pack-500-editorial.webp', variants: [{ label: '6 botellas de 500 ml', price: 58000, sku: 'MSX500' }] },
];
