...
export default function Home() {
  ...
  return <main className={scrolled ? 'is-scrolled' : ''}>
    ...
    <section className="pause-banner" data-reveal>
      <AssetSlot name="PAUSA_EDITORIAL · botellas para compartir" source={media.ritual} alt="Dos kombuchas Wandra listas para compartir" className="pause-image" />
    ...
    <section className="ritual-section" id="ritual" data-reveal><div className="ritual-video"><AssetSlot name="RITUAL_VIDEO · foto o video de fermentación" source={media.ritualVideo} alt="Proceso de fermentación de Kombucha Wandra" className="video-slot"><span className="video-placeholder">01<br /><b>UN SORBO<br />DESPIERTA</b></span></AssetSlot></div><div className="ritual-stills"><div className="still-copy"><p className="eyebrow">Tu pausa favorita</p><h2>VIVE<br />A TU <i>RITMO</i></h2><p>Una kombucha fría, una pausa real y el sabor de hacer las cosas despacio.</p></div><AssetSlot name="RITUAL_EDITORIAL · escena de consumo" source={media.ritual} alt="Kombucha Wandra servida para un momento de pausa" className="ritual-image"><span className="asset-shape shape-circle" /></AssetSlot></div></section>
    ...
    <section className="share-pack" data-reveal><div className="share-pack-copy"><p className="eyebrow">Mejor cuando se comparte</p><h2>Seis razones<br />para decir<br /><i>¡salud!</i></h2><p>Para compartir, regalar o tener tu nevera lista. Tu ritual favorito, en un six pack.</p><div><a className="button share-primary" href="/productos/six-pack-kombucha-280-ml">Six pack 280 ml · $42.000 <span aria-hidden="true">↗</span></a><a className="share-secondary" href="/productos/six-pack-kombucha-500-ml">También en 500 ml · $62.000 →</a></div></div><AssetSlot name="SIX_PACK_EDITORIAL · para compartir" source={media.pack280} alt="Six pack de Kombucha Wandra para compartir" className="share-pack-image" /></section>
