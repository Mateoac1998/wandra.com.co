...
export default function Home() {
  ...
  return <main className={scrolled ? 'is-scrolled' : ''}>
    ...
    <header className={`site-header ${menuOpen ? 'menu-open' : ''}`}>
      <a className="wordmark brand-logo" href="#inicio" aria-label="Wandra, inicio"><img src="/assets/cloudinary-upload/wandra-logo-web.webp" alt="Wandra" /></a>
    ...
    <section className="hero kombucha-hero" id="inicio" aria-label="Presentación de Wandra">
      ...
      <div className="hero-bottle-stage" aria-label="Fotografía editorial de Wandra"><AssetSlot name="HERO_EDITORIAL · foto de campaña" source="/assets/cloudinary-upload/wandra-hero-editorial.webp" alt="Productos Wandra en una fotografía editorial" className="hero-bottle" /><span className="hero-number">0{heroSlide + 1}</span></div>
