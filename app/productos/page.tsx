...
export const metadata: Metadata = {
  ...
  description: 'Conoce Mateo, ghee, aceites, mantequillas y bebidas funcionales de Wandra.',
...
export default function ProductsPage() {
  ...
  return <main className="content-page catalog-page">
    <header className="content-hero"><a className="mini-logo" href="/" aria-label="Volver al inicio">Wandra</a><p className="eyebrow">Tienda Wandra</p><h1>ALIMENTOS<br /><i>VIVOS</i></h1><p>Una selección de Mateo, ghee, aceites, mantequillas y bebidas para acompañar tu rutina.</p></header>
