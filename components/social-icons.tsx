...
export function WhatsAppIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 448 512" width="27" height="31" fill="currentColor" aria-hidden="true" {...props}>
...
export function InstagramIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="21" height="21" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" aria-hidden="true" {...props}>
