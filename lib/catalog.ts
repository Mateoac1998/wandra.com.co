...
export const products: Product[] = [
  ...
  { slug: 'kombucha-jengibre', name: 'Kombucha de Jengibre', sku: 'KJEN', category: 'Kombucha', description: 'Kombucha artesanal con un perfil fresco y especiado de jengibre.', image: media.ginger, images: [media.ginger, media.gingerAlternate], variants: [{ label: '280 ml', price: 8000, sku: 'KJEN028' }, { label: '500 ml', price: 12000, sku: 'KJEN050' }] },
